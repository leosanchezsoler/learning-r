...
d <- 2.5
e <- 5L # La 'L' hace que el valor pase de 'double' a 'int'
f <- as.complex(-1)

## que tipo de variable es?

# rm() --> para eliminar variables del entorno
...
nombre_peliculas <- c("El diario de Noa", "Pocahontas", "Greenland", "Joker")
...
# no va a dar error pero rellena el resto de valores volviendo a empezar según el array
